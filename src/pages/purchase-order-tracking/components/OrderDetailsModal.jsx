...
const OrderDetailsModal = ({ order, isOpen, onClose, currentLanguage }) => {
  ...
  // Communications desde Sheets y filtrado por orden
  ...
  const handleUpdateStatus = () => {
    // Aquí luego llamamos a tu API/Sheets para actualizar estado.
    console.log('Update Status clicked for', order?.poNumber);
    alert(currentLanguage === 'es' ? 'Acción de actualizar (demo)' : 'Update action (demo)');
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-card rounded-lg shadow-modal max-w-4xl w-full mx-4 max-h-[90vh] overflow-hidden">
        ...
        <div className="flex justify-end space-x-3 p-6 border-t border-border">
          ...
          <Button type="button" variant="default" onClick={handleUpdateStatus}>
